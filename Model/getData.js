...
// Sự kiện khi thêm các phần tử vào mảng
...
// xóa vị trí hiện tại khi chọn header khác
...
// Lấy selector để hiển thị kết quả
...
// Đếm có bao nhiêu số nguyên dương có trong mảng
function countIntegers(arr) {
    // chuyển các giá trị trong mảng thành kiểu number sau đó mới lấy ra số nguyên
